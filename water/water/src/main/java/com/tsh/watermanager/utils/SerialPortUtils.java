 ...
 * Description: 串口操作类
 */
import com.tsh.watermanager.config.ParamConfig;
            ...
            if (commPortId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
                ...
                if (paramConfig.getSerialNumber().equals(commPortId.getName())) {
                    ...
                    try {
                        ...
                        serialPort = (SerialPort) commPortId.open(Object.class.getSimpleName(), 1000);
                        // 设置串口监听
...
//                         设置串口通讯参数:波特率，数据位，停止位,校验方式
                        ...
                        System.out.println("串口打开成功！"+commPortId.getPortType());
